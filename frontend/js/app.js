...
const API = isLocal ? 'http://localhost:5000/api' : 'https://portfolio-fbhl.onrender.com/api';
...
async function loadProfile() {
  ...
  const socialMap = { github: 'github', linkedin: 'linkedin', instagram: 'instagram', youtube: 'youtube', whatsapp: 'whatsapp' };
